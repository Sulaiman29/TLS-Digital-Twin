...
MQTT_PORT = 1883
TOPIC_METRICS = "simulation/multi/metrics/live"
...
SUMO_CFG = os.path.join(script_dir, "../../cfg/corridor.sumocfg")
...
def run_simulation():
    ...
    # Force both TLS to use our 4-phase program
    for tls_id in ["C1", "C2"]:
        try:
            traci.trafficlight.setProgram(tls_id, "1") 
            print(f">>> SUCCESS: Forced TLS '{tls_id}' to use Program '1' (4-Phase)")
        except Exception as e:
